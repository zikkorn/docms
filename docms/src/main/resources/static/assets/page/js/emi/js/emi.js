(function () {
  ...
  $('.btn_date').off('click').on('click', function () {
    $.Pop(`  <div class="form-group" style="margin-bottom: 1rem;margin-top: 20px;">
                  <span style="font-size:16px;margin-left: 71px;">装备名称：</span>
              ...
              <div class="form-group" style='margin-bottom: 1rem;'>
                  <span style="font-size:16px;margin-left: 71px">主要用途：</span>
                  <input type="text" style="text-align: center;color: #fff;font-size: 14px;width: 200px;border-radius: 5px;height: 30px;" class="form-control"/>
              </div>
              <div class="form-group" style='margin-bottom: 1rem;'>
                  <span style="font-size:16px;margin-left: 71px">装备类型：</span>
                  <input type="text" style="text-align: center;color: #fff;font-size: 14px;width: 200px;border-radius: 5px;height: 30px;" class="form-control"/>
              </div>
              <div class="form-group" style='margin-bottom: 1rem;'>
                  <span style="font-size:16px;margin-left: 40px">战术技术性能：</span>
                  <input type="text" style="text-align: center;color: #fff;font-size: 14px;width: 200px;border-radius: 5px;height: 30px;" class="form-control"/>
              </div>
              <div class="form-group" style='margin-bottom: 1rem;'>
                  <span style="font-size:16px;margin-left: 71px">主要特点：</span>
                  <input type="text" style="text-align: center;color: #fff;font-size: 14px;width: 200px;border-radius: 5px;height: 30px;" class="form-control"/>
              </div>
              <div class="form-group" style='margin-bottom: 1rem;'>
                  <span style="font-size:16px;margin-left: 71px">定型时间：</span>
                  <input type="text" style="text-align: center;color: #fff;font-size: 14px;width: 200px;border-radius: 5px;height: 30px;" class="form-control"/>
              </div>
              <div class="form-group" style='margin-bottom: 1rem;'>
                  <span style="font-size:16px;margin-left: 71px">编配级别：</span>
                  <input type="text" style="text-align: center;color: #fff;font-size: 14px;width: 200px;border-radius: 5px;height: 30px;" class="form-control"/>
              </div>
              <div class="form-group" style='margin-bottom: 1rem;'>
                  <span style="font-size:16px;margin-left: 40px">承研承制单位：</span>
                  <input type="text" style="text-align: center;color: #fff;font-size: 14px;width: 200px;border-radius: 5px;height: 30px;" class="form-control"/>
              </div>
              <div class="form-group" style='margin-bottom: 1rem;'>
                  <span style="font-size:16px;margin-left: 105px">备注：</span>
                  <input type="text" style="text-align: center;color: #fff;font-size: 14px;width: 200px;border-radius: 5px;height: 30px;" class="form-control"/>
              </div>
               <div class="form-group" style="margin-bottom: 1rem;">
                  <span style="font-size:16px;margin-left: 74px;">上传文档：</span>
          ...
          yes: {
            vla: "提交", class: "btn-primary btn", ope: function () {
                $('tbody').append(`<tr>
                                    ...
                                    <td>
                                        <button class="btn btn-outline-primary emi_revise">修改</button>
                                        ...
                                        <button class="btn btn-outline-danger emi_delete">删除</button>
                                    </td>
                                </tr>`)
              $('.box').remove()
  ...
  $(document).on('click', '.emi_revise ', function () {
