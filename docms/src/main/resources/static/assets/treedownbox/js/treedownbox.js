        ...
        $("#jeselbox" + uuid).on("click", function() {
            ...
            openCell.find("dd").on("click", function() {
                ...
                if (opts.itemfun != undefined && typeof opts.itemfun === "function") {
                    opts.itemfun(inelem, index, vals, txts,$(this));
        ...
        $("option, optgroup", _this.elCell).each(function() {
            ...
            if ($(this).is("option")) {
                ...
                if ($(this).is(":selected")) {
                    ...
                    selHtml += '<dd key-id="'+ $(this).attr('key-id') +'" data-key="' + $(this).attr('data-key') +'" title="' + text + '" item="' + (s++) + '" class="' + opts.currCls + ' ' + groupCell + '">' + text + "</dd>";
                } else {
                    selHtml += '<dd key-id="'+ $(this).attr('key-id') +'" data-key="' + $(this).attr('data-key') +'" title="' + text + '" item="' + (s++) + '" val="' + $(this).attr("value") + '" class="' + groupCell + '">' + text + "</dd>";
                }
            } else {
                //模拟分组html
                selHtml += '<dt key-id="'+ $(this).attr('key-id') +'" data-key="' + $(this).attr('data-key') +'" title="' + $(this).attr("label") + '" val="' + $(this).attr("label") + '">' + $(this).attr("label") + "</dt>";
            }
        });
